...
folded = torch.nn.functional.unfold(image_tensor, (5, 5), stride=5, padding=10)
print(folded.shape)
recovered_tensor = torch.nn.functional.fold(folded, output_size=(128, 128), kernel_size=(5, 5), stride=5, padding=10)
