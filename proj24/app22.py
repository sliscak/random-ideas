...
DATASET_PATH = st.text_input('DATASET PATH', value='C:\\Users\\Admin\\Dataset\\tiny-imagenet-200\\test\\images\\')
dataset = ImageDataset(path=DATASET_PATH, size=5, image_size=(128, 128))
...
with torch.no_grad():
    dataset = ImageDataset(path="C:\\Users\\Admin\\Dataset\\tiny-imagenet-200\\test\\images\\", size=100, image_size=(64, 64))
