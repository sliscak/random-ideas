...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.lk1 = LongKernel(10, 12288)
        self.lk2 = LongKernel(10, 12288)
        self.lk3 = LongKernel(10, 12288)
        self.lk4 = LongKernel(10, 12288)
        self.lk5 = LongKernel(10, 12288)
        self.lk6 = LongKernel(10, 12288)
