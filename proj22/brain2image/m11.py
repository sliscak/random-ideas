...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # self.values = nn.Parameter(torch.randn((50, )))
    ...
    def forward(self, image):
        ...
        # key = torch.conv2d(image, weight=self.kernel, stride=2)
        # key = torch.conv2d(image, weight=self.kernel2, stride=2)
        # st.write(f'KERNEL SHAPE: {self.kernel2.shape}')
        # key = self.seq(torch.flatten(image))
        #
