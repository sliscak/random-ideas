    ...
    for i_episode in range(20):
        ...
        for t in range(100):
            ...
            for u in range(1):
                ...
                pred_volume = net(torch.Tensor([1, 1]).to(device))
                ...
                pred_volume = net(torch.Tensor([1, 1]).to(device)).detach().cpu().numpy()
                cv2.imshow('net', pred_volume[0])
